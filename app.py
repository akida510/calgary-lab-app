...
st.markdown("""
    ...
    /* 모바일에서 8.5" 너비의 종이를 화면 너비에 맞게 전체 스케일 조정 */
    @media screen and (max-width: 816px) {
        .paper-scaler { padding: 0; background-color: transparent; }
        .invoice-container {
            transform: scale(calc(100vw / 840)); 
            transform-origin: top center;
            /* 스케일링으로 생기는 하단 공백 제거 */
            margin-bottom: calc(-1056px * (1 - (100vw / 840))); 
        }
    }
    ...
    @media print {
        ...
        .paper-scaler { background-color: white; padding: 0; }
