...
with t1:
    ...
    f_cl_input = c2.text_input("👉 클리닉 이름 직접 입력") if sel_cl == "➕ 직접 입력" else ""
    ...
    f_doc_input = c3.text_input("👉 의사 이름 직접 입력") if sel_doc == "➕ 직접 입력" else ""
    ...
    # 💡 마감일 선택 시 즉시 주말 제외 2일 전으로 출고일 자동 갱신
