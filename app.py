...
st.markdown("""
    ...
    div[data-testid="column"] .stButton>button {
        ...
        min-height: 24px !important; width: auto !important;
    }

    /* 인보이스 전용 (사진 속 검정 테두리 박스 재현) */
    .invoice-card {
...
with tab2:
    ...
    if st.session_state.selected_invoice:
        ...
        st.divider()
        # [코드 노출 방지] 중괄호 에러를 피하기 위해 분리하여 작성
        invoice_html = f"""
        <div class="invoice-card">
            <table style="width: 100%; border: none;">
                <tr>
                    ...
                    <td style="text-align: right; vertical-align: top;">
                        ...
                        <div style="margin-top: 30px; text-align: left; font-size: 13px; line-height: 1.3; margin-left: auto; width: 230px;">
                            <b>Ship To:</b><br>{inv['Clinic']}<br>Dr. {inv['Doctor']}<br>{inv['Addr']}<br>{inv['City']}<br>{inv['Phone']}
                        </div>
                    </td>
                </tr>
            </table>
            <div style="margin: 60px 0 15px 0; font-size: 16px; border-bottom: 1.5px solid black; padding-bottom: 10px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 15px;">
                ...
                <tr>
                    <td style="padding: 25px 0; height: 420px; vertical-align: top;">Nightguard ({inv['Material']}) {inv['Arch'].upper()}</td>
                    <td style="padding: 25px 0; text-align: right; vertical-align: top;">$180.00</td>
                </tr>
            </table>
            ...
            <div style="margin-top: 100px; text-align: center;">
                <div style="font-size: 17px; font-weight: bold; text-decoration: underline; margin-bottom: 20px;">All dental products we offer are custom made in Canada.</div>
                <div style="font-size: 11px; line-height: 1.7; padding: 0 40px; font-weight: 500;">Please ensure your monthly payment is made within 30 days of receiving your statement. Any balances remaining after 30 days will be automatically charged to the credit card on file. Otherwise, any balances over 30 days will be subject to a finance charge of 1.5% per month. This has an equivalent rate of 19.562% APR. Thank you.</div>
            </div>
        </div>
        """
