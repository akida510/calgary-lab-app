    ...
    if st.session_state.selected_invoice:
        ...
        <div class="invoice-card">
            <table style="width: 100%; border: none;">
                <tr>
                    ...
                    <td style="text-align: right; vertical-align: top;">
                        <div style="font-size: 30px; font-weight: bold; letter-spacing: 2px;">INVOICE</div>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 15px;">
                ...
                <tr>
                    <td style="padding: 25px 0; height: 420px; vertical-align: top;">
            ...
            <div style="border-top: 2.5px solid black; padding-top: 15px; display: flex; justify-content: space-between; font-weight: bold; font-size: 16px;">
