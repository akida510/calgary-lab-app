...
st.markdown("""
    ...
    .invoice-paper {
        ...
        width: 816px !important;    /* 레터지 고정 너비 */
        height: 1056px !important;  /* 레터지 고정 높이 */
    ...
    /* 폰 화면(816px 미만)일 때 종이 전체를 비율대로 축소 */
    @media screen and (max-width: 816px) {
        .invoice-paper {
            transform: scale(calc(100vw / 840)); 
            transform-origin: top center;
            margin-bottom: calc(-1056px * (1 - (100vw / 840))); /* 축소된 만큼 여백 보정 */
        }
    }
    ...
    @media print {
        ...
        .invoice-outer-frame { background-color: white; padding: 0; }
        .invoice-paper { transform: none !important; margin: 0 !important; width: 100% !important; }
    }
    </style>
